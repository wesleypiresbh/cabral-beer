...
_s(ProductCard, "15BZ+qmXUFCRkXuIMB3dA/rFKTU=", false, function() {
    return [
...
function CategoriaPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoriaPage.useEffect": ()=>{
            const fetchCategoryData = {
                "CategoriaPage.useEffect.fetchCategoryData": async ()=>{
                    try {
                        const categories = __turbopack_context__.r("[project]/src/data/categories.json (json)").default;
                        const category = categories.find({
                            "CategoriaPage.useEffect.fetchCategoryData.category": (c)=>c.slug === slug
                        }["CategoriaPage.useEffect.fetchCategoryData.category"]);
                        setCategory(category);
                        const products = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryProducts"])(slug); // Carrega apenas produtos da categoria
                        setCategoryProducts(products);
                    } catch (error) {
                        console.error('Erro ao carregar dados da categoria:', error);
                    }
                }
            }["CategoriaPage.useEffect.fetchCategoryData"];
            fetchCategoryData();
        }
    }["CategoriaPage.useEffect"], [
        slug
...
_s(CategoriaPage, "nWgnI1fgB7PFUiRL0CzNM33OFOs=", false, function() {
    return [
...
//# sourceMappingURL=_b2f183f5._.js.map